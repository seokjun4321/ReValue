...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/RCT-Folly.default-Fabric/RCT-Folly_privacy.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/React-Core-60309c9c/React-Core_privacy.bundle"
