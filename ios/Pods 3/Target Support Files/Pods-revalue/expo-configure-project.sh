...
with_node \
  ...
  --target "/Users/garden/Desktop/corsor/ReValue/ios/Pods/Target Support Files/Pods-revalue/ExpoModulesProvider.swift" \
  --entitlement "/Users/garden/Desktop/corsor/ReValue/ios/revalue/revalue.entitlements" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo" "expo-apple-authentication" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-device" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-location" "expo-maps" "expo-notifications" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
